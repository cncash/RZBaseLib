...
import com.runzhong.technology.util.tt.TTAdManagerHolder;
...
public abstract class RZSplashActivity extends Activity implements RZManager.OnSplashADLoadListener{
    private RoundProgressBar cutDownBar;
    ...
    private void fetchTTSplashAD() {
        mTTAdNative = TTAdManagerHolder.getInstance(getApplicationContext(), getTTAppId()).createAdNative(this);
        //开屏广告参数
        AdSlot adSlot = new AdSlot.Builder()
                .setCodeId(getTTCodeId())
        ...
        mTTAdNative.loadSplashAd(adSlot, new TTAdNative.SplashAdListener() {
            ...
            public void onError(int code, String message) {
                RZUtil.log("穿山甲onError:" + message);
                RZManager.getInstance().onUMEvent(RZConst.AD_THIRD_PLATFORM_ERROR_EVENT_ID,
                        RZManager.getInstance().getErrorEventMap(RZConst.AD_PLATFORM_TT,
